...
const AIActions = () => {
    ...
    const handleExplainConcept = async (e) => {
        ...
        try {
            const { explanation } = await aiServices.explainConcept(
                documentId,
                concept
            );
                    ...
                    <div className='group p-5 bg-linear-to-br from-slate-50/50 to-white rounded-xl border border-slate-200/60 hover:border-slate-300/60 hover:shadow-md transition-all  duration-300'>
                        <div className='flex items-start justify-between gap-4'>
                            ...
                            <button onClick={handleGenerateSummary}
                                ...
                                className='shrink-0 h-10 px-5 bg-linear-to-r from-teal-500 to-teal-600 hover:from-teal-600 hover:to-teal-600 text-white text-sm font-semibold rounded-xl transition-all duration-200 shadow-lg shadow-blue-500/25 disabled:opacity-50 disabled:cursor-not-allowed active:scale-[0.98]  '
                            >
                        ...
                        <form onSubmit={handleExplainConcept}>
                            ...
                            <div className='flex items-center gap-3'>
                                <input
                                    ...
                                    placeholder='e.g., "Types of algorithm"'
                                ...
                                <button
                                    ...
                                    className='shrink-0 h-11 px-5 bg-linear-to-r from-emerald-600  to-emerald-500 hover:from-emerald-600 hover:to-emerald-600 text-white text-sm font-semibold rounded-xl transition-all duration-200 shadow-lg  shadow-purple-500/25 disabled:opacity-50  active:scale-[0.98]'
                                >
