...
const QuizResultPage = () => {
    ...
    const incorrectAnswer = totalQuestions - correctAnswers
    ...
    return (
        <div className="max-w-5xl mx-auto">
            ...
            {/* Score Card */}
            <div className="bg-white/80 backdrop-blur-xl border-2 border-slate-200 rounded-2xl shadow-xl shadow-slate-200/50 p-8 mt-8">
                <div className="text-center space-y-6">
                    ...
                    <div className="flex items-center justify-center gap-4 pt-4">
                        ...
                        <div className="flex items-center gap-2 px-4 py-2 bg-rose-50 border border-rose-200 rounded-xl">
                            ...
                            <span className="text-sm font-semibold text-slate-700">{incorrectAnswer} InCorrect</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="space-y-6">
                ...
                {detailedResults.map((result, index) => {
                    ...
                    const correctAnswerIndex = result.correctAnswer.startWith('O') ? parseInt(result.correctAnswer.substring(1)) - 1
                                    ...
                                    return (
                                        <div
                                            ...
                                            <div className="flex items-center justify-between gap-3">
                                                <span className={`text-sm font-medium ${isCorrectOption ? 'text-emerald-900'
                                                    : isWrongAnswer
                                                        ? 'text-rose-900'
                                                        : 'text-slate-700'
                                                    }`}>
                            ...
                            {result.explanation && (
                                <div className="p-4 bg-linear-to-r from-slate-50 to-slate-100/50 border border-slate-200 rounded-xl">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div className="flex-1">
                                            <p className="text-xs font-semibold text-slate-600 uppercase tracking-wide">Explanation</p>
            ...
            <div className="mt-8 flex justify-center">
                <Link
                    to={`/documents/${quiz.document._id}`}
                >
                    <button className="group relative px-8 h-12 bg-linear-to-r from-emerald-500 to-teal-500 hover:from-emerald-500 hover:to-teal-500 text-white font-semibold text-sm rounded-xl transition-all duration-200 shadow-lg shadow-emerald-500/25 active:scale-95 overflow-hidden">
