        ...
        <div className='max-w-4xl mx-auto'>
            ...
            <div className='mb-6'>
                ...
                <div className='relative h-2 bg-slate-100 rounded-full overflow-hidden '>
                    <div className='absolute inset-y-0 left-0 bg-linear-to-r from-emerald-500 to-teal-500 rounded-full transition-all duration-300 ease-out '
                    ...
                    {currentQuestion.options.map((option, index) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                {/* Selected Checkmark */}
                                {isSelected && (
                                    <CheckCircle strokeWidth={2.5} className='ml-auto w-5 h-5 text-emerald-500' />
                                )}
                            </label>
                        )
                    })}
