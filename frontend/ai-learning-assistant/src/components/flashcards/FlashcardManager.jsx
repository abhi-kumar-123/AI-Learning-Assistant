...
const FlashcardManager = ({ documentId }) => {
    ...
    const handleConfirmDelete = async () => {
        ...
        setDeleting(true);
        try {
            await flashcardService.deleteFlashcards(setToDelete._id);
        ...
        return (
            <div className='space-y-8'>
                ...
                <button
                    ...
                    text-slate-600   hover:from-emerald-600   font-medium text-sm transition-colors duration-200 '
                >
